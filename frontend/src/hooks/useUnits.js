...
const useUnit = (options = {}) => {
    ...
    */
    ...
    | IMPORTANT
    |--------------------------------------------------------------------------
    | Keep the latest units available without making getUnits depend on
    | the units state.
    |--------------------------------------------------------------------------
    */
    ...
    | AUTO FETCH GUARD
    |--------------------------------------------------------------------------
    | Prevent repeated auto-fetch caused by changing callback references.
    |--------------------------------------------------------------------------
    */
        ...
        async (params = {}) => {
            ...
            */
            ...
            try {
                ...
                |------------------------------------------------------------------
                |
                | Keep this while debugging. Remove it later if desired.
                |------------------------------------------------------------------
                */
    ...
    */
    ...
    const refreshUnits =
        useCallback(
            async (params = {}) => {
                /*
                |------------------------------------------------------------------
                | Explicit refresh is allowed even after a previous request.
                |------------------------------------------------------------------
                */
    ...
    | IMPORTANT:
    |
    | Do not put units in getUnits dependencies.
    |
    ...
    */
    ...
    useEffect(() => {
        ...
        /*
        |----------------------------------------------------------------------
        | Prevent automatic fetch from running repeatedly.
        |----------------------------------------------------------------------
        */
