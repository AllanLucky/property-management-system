...
const Dashboard = () => {
  ...
  */
  ...
  const userName =
    dashboardUser?.name ||
    authUser?.name ||
    `${dashboardUser?.first_name || authUser?.first_name || ""} ${
      dashboardUser?.last_name || authUser?.last_name || ""
    }`.trim() ||
    dashboardUser?.email ||
    authUser?.email ||
    "User";
      ...
      <div className="min-h-[60vh] flex items-center justify-center px-4">
        <div className="w-full max-w-md bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-2xl p-6 text-center shadow-sm">
          ...
          <button
            type="button"
            onClick={() => refresh()}
            className="mt-5 inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium transition"
          >
  ...
  */
  ...
  const statCards = [
...

    {
      ...
      description: "Current collected rent",
      icon: DollarSign,
      iconClass:
        ...
        {hasWidget("tenancies") && (
          <div className="bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-2xl p-5 shadow-sm">
            ...
            <div className="mt-6 space-y-4">
              ...
              <StatusRow
                label="Active"
                value={tenancies?.active}
                total={tenancies?.total}
                icon={CheckCircle2}
          ...
          <div className="bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-2xl p-5 shadow-sm">
            ...
            <div className="mt-6 space-y-4">
              ...
              <MoneyRow
                ...
                value={financials?.rent_collected}
                icon={ArrowUpRight}
                positive
              />
