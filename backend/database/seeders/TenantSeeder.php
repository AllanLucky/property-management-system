...
class TenantSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        | IMPORTANT:
        |
        | The User table is the source of the tenant's authentication/account
        | information.
        |
        | Tenant-specific information is stored in the tenants table.
        |
        | Tenant activity is controlled ONLY by:
        |
        |     tenants.status
        |
        ...
        */
        ...
        foreach ($tenants as $data) {
            ...
            |--------------------------------------------------------------------------
            |
            | User is the source of authentication/account information.
            |
            */
            ...
            |--------------------------------------------------------------------------
            |
            | Email is used as the stable user identifier.
            |
            | withTrashed() allows us to recover a previously deleted account.
            |
            */
            ...
            if (!$user) {
                ...
                $user = User::create([
                    ...
                    */
                    ...
                    /*
                    | Tenant users should be able to authenticate once
                    | their tenant account is active/approved.
                    */
                ...
                */
                ...
                /*
                |--------------------------------------------------------------------------
                | Update User From Seeder Data
                |--------------------------------------------------------------------------
                |
                | The User table remains the source for account information.
                |
                */
            ...
            */
            ...
            |--------------------------------------------------------------------------
            |
            | tenant_number is the unique tenant identifier.
            |
            */
            ...
            */
            ...
            /*
            |--------------------------------------------------------------------------
            | Ensure Correct User Relationship
            |--------------------------------------------------------------------------
            */
        ...
        */
        ...
        $this->command?->info(
            'Tenant users login password: Password@123'
        );


        $this->command?->info(
            'User accounts are linked to tenants through tenants.user_id.'
        );
